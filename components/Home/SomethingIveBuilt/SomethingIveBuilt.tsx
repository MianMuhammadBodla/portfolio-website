        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
           ...
           transition-opacity opacity-20 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <a href="https://github.com/MianMuhammadBodla/Calculator" target={"_blank"} rel="noreferrer">
                <div
                  // onClick={}
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">CALCULATOR </span>
                <a>
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                  muhammad-bodla-simple-calculator
                  </span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                {"I am excited to share that I have successfully completed my first major assignment as part of my studies at PIAIC. For our end-of-quarter project, I developed a simple calculator using npm and TypeScript."}
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <a href="https://www.npmjs.com/package/muhammad-bodla-simple-calculator" target={"_blank"} rel="noreferrer">
                  <ExternalLink url={""} router={router} />
                </a>
                <div className="z-10 flex fle-row space-x-5 sm:pt-0 pt-2">
                <GithubIcon link="https://github.com/MianMuhammadBodla/Calculator" />
              </div>
              </div>
            </div>
          </div>
