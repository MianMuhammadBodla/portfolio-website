  ...
  useEffect(() => {
    ...
    if (!IsBlackListEmpty) {
      if (userData) {
        ...
        if (process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES && userData && process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES.includes(userData.country)) {
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/mianmuhammadbodla"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
