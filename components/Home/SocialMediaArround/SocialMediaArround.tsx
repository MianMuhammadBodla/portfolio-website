      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/MianMuhammadBodla"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/muhammad-bodla/"} />
            {/* Instagram Icon */}
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:244401711@formanite.fccollege.edu.pk" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                Mail Me<span className="text-AAsecondary"> By Clicking </span><span className="text-AAsecondary"></span>Here
              </span>
            </a>
          </motion.div>

          <div className="h-48 w-0.5 bg-gray-400"></div>
        </div>
      </motion.div>
    </>
  );
